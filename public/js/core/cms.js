...
const CMS = {
        ...
        try {
            ...
            if (data.success && data.page) {
                ...
                contentArea.innerHTML = `
                    ...
                    <div class="page-body" style="line-height: 1.8; color: var(--text-main);">
                        ${data.page.content}
                    </div>
                ...
                contentArea.innerHTML = `
                    <div class="error-msg">
                        ...
                        <p>Die angeforderte Seite "${slug}" existiert leider nicht.</p>
    ...
    interceptLinks() {
        document.addEventListener('click', (e) => {
            ...
            if (href.startsWith('/page?slug=') || href.startsWith('page?slug=') || href === 'index' || href === '/') {
                e.preventDefault();
    ...
    async loadNews() {
        ...
        try {
            const res = await fetch(`${API_URL}/cms/news/all`);
            const data = await res.json();
