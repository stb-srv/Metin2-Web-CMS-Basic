...
(function () {
    ...
    function applyBranding(customTheme) {
        ...
        const logo = customTheme.site_logo;
    ...
    function applyCustomVars(s) {
        let vars = '';
        const p = s.theme_primary_color || s.primary_color;
        const a = s.theme_accent_color || s.accent_color;
        const b = s.theme_bg_color || s.bg_color;
        const r = s.theme_border_radius || s.border_radius;
        ...
        const cMain = s.theme_color_text_main;
        const cMuted = s.theme_color_text_muted;
        const cAccent = s.theme_color_text_accent;
        const cMenuHeader = s.theme_color_menu_header;
